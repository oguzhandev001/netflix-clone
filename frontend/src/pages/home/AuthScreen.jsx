  ...
  return (
    <div className="hero-bg relative">
        ...
        <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
            ...
            <input type="email" placeholder="Email Adress" className="p-2 rounded flex-1 bg-black/80 border border-gray-700" value={email} onChange={(e) => {setEmail(e.target.value)}}></input>
            <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py2 rounded flex justify-center items-center">
                Get Started
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-lg md:text-xl">Watch on Smart TV, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</p>
                </div>
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto item-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
                <div className="flex-1 relative">
